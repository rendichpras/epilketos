    ...
    <div className="w-full max-w-md mx-auto">
      <div className="text-center flex flex-col items-center gap-8">
        ...
        <div className="animate-in fade-in-50">
          <h1 className="text-3xl font-bold mb-3 text-primary">Terima Kasih!</h1>
        ...
        {receipt && (
          <div className="w-full rounded-xl border bg-card/50 p-6 animate-in fade-in-50">
            <div className="space-y-3">
              <h2 className="font-medium text-primary">Nomor Tanda Terima</h2>
        ...
        <a
          href="/"
          className="h-12 px-8 rounded-lg border bg-card hover:bg-accent flex items-center justify-center animate-in fade-in-50 w-full sm:w-auto"
        >
          Kembali ke Beranda
        </a>
      </div>
