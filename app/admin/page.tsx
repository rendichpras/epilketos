  ...
  return (
    <div className="container space-y-6 p-6">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">Selamat datang di panel administrasi E-Pilketos</p>
      </div>
      {/* Stats Grid */}
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-xl border bg-card p-6 shadow-sm transition-colors hover:bg-accent/50">
          ...
          <div className="mt-1 text-sm text-muted-foreground">Token Terpakai</div>
        </div>
        <div className="rounded-xl border bg-card p-6 shadow-sm transition-colors hover:bg-accent/50">
          <div className="text-3xl font-bold text-foreground">{totalCandidates}</div>
          <div className="mt-1 text-sm text-muted-foreground">Pasangan Kandidat</div>
        </div>
      </div>
      {/* Quick Actions */}
