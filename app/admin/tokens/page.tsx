  ...
  return (
    <div className="container space-y-6 p-6">
      ...
      <div className="flex flex-col gap-1">
        <h1 className="text-3xl font-bold tracking-tight text-primary">Token</h1>
        <p className="text-muted-foreground">Buat dan kelola token untuk pemilih</p>
      </div>
      ...
      <div className="rounded-xl border bg-card p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Stat label="Token Belum Digunakan" value={countByStatus["unused"] ?? 0} />
          ...
          <table className="w-full caption-bottom text-sm">
            <thead className="[&_tr]:border-b">
              <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                ...
                <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Jumlah</th>
                <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Kadaluarsa</th>
                <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Catatan</th>
              </tr>
            </thead>
            <tbody className="[&_tr:last-child]:border-0">
              {batches.map((b) => (
                ...
                >
                  <td className="p-4 align-middle">{b.createdAt.toLocaleString()}</td>
